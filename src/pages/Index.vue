  ...
  <div class="bg-white">
    ...
    <div class="relative bg-gray-900">
      ...
      <div aria-hidden="true" class="absolute inset-0 overflow-hidden">
        <img src="https://source.unsplash.com/lXLct9D-ARE" alt="" class="w-full h-full object-center object-cover" />
      </div>
      ...
      <div class="relative max-w-3xl mx-auto py-32 px-6 flex flex-col items-center text-center sm:py-64 lg:px-0">
        <h1 class="text-4xl font-extrabold tracking-tight text-white lg:text-6xl">FIMEats</h1>
        <p class="mt-4 text-xl text-white">La comida que buscas, en el lugar que la buscas.</p>
